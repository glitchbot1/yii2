...
-- Started on 2018-11-23 21:12:07
...
INSERT INTO post VALUES (4, 1, 'Продам квартиру', 'Продам квартиру срочно!', '2018-11-20 18:54:29', 340000000, 2, 1, true, '754909586036514.jpg');
INSERT INTO post VALUES (6, 2, 'Продам стиральную машинку', 'Быстрое освежение слабозагрязненного белья с помощью программы «Супербыстрая 30’/15’».
...
INSERT INTO post VALUES (7, 3, 'Продам автомобиль! Срочно', 'Синий,классный автомобиль. Продам недорого, только Барнаул,просьба после 19 не беспокоить', '2018-11-21 10:56:19', 20000000, 1, 7, true, 'audi.jpg');
INSERT INTO post VALUES (10, 1, 'Продам ноутбук', 'Заряд батареи держит плохо! От сети работает нормально! Комплект ноутбук зарядка и мышь!', '2018-11-23 05:50:10', 4000, 1, 5, true, 'd2133e45.jpg');
INSERT INTO post VALUES (11, 1, 'Продам часы', 'Новые Часы с керамическом браслетом ,на гарантии . Покупала за 5490,отдам за 3000р. Коробка и пакет оригинальный ) продажа в связи с покупкой часов apple', '2018-11-23 05:52:49', 3000, 1, 1, true, 'f89e0d94764731a5ed2fbb5062e3ff7e.jpeg');
INSERT INTO post VALUES (12, 1, 'Продам часы', 'Часы в хорошем состояние без преувеличений, приобрёл их в августе 2017 года, имеется доп ремешок на 42 мм, коробка , зарядное устройство емеются, не носил на протяжении всего лета и до сегодняшнего дня так как купили новые.', '2018-11-23 05:57:19', 5000, 3, 4, true, 'Часы-2.jpg');
INSERT INTO post VALUES (13, 1, 'Продам автомобиль', 'Автомобиль в хорошем состоянии. «Сел и поехал» на зимних колёсах . Комплектация Спорт. Звоните, отвечу на все вопросы.Автомобиль Японской сборки.', '2018-11-23 05:57:57', 5000000, 1, 1, true, 'RYAAAgJFkOA-960.jpg');
INSERT INTO post VALUES (9, 4, 'Демонтаж любой сложности', 'Демонтируем различные перегородки, стены, дверные проемы, ниши, кафельную плитку и т.д. Утепляем балконы. Мелкосрочный ремонт по электрике. Работаем быстро, качественно, не пьем не курим. Цены адекватные!', '2018-11-21 11:15:40', 1000, 1, 5, true, '4936603391.jpg');
INSERT INTO post VALUES (14, 4, 'Продам кроссовки', 'Продам кроссовки Nike air max (оригинал) в хорошем состоянии, размер 38', '2018-11-23 06:01:15', 4000, 3, 2, true, '1cde0a0c.jpg');
INSERT INTO post VALUES (15, 4, 'Продам куртку', 'Куртка из экокожи, состояние идеальное, цвет непонятный (серый хаки), кожа очень мягкая, рукав и низ куртки на резинке из гофрированной кожи, справа на груди выдавленная надпись. Железный замок до конца капюшона и на карманах. ', '2018-11-23 06:02:20', 12000, 3, 7, true, '1019456312.jpg');
INSERT INTO post VALUES (16, 4, 'Продам шапку', 'В отличном состоянии!
Всё находится в Кемерово!', '2018-11-23 06:04:01', 1500, 3, 4, true, 'dpgm0002036b.jpeg');
INSERT INTO post VALUES (8, 4, 'Рублю дерgh', 'На рублю дров за вас всего 300р в час.dfgdfg', '2018-11-21 11:07:44', 500, 6, 1, true, '1510512371082.jpg');
...
-- Completed on 2018-11-23 21:12:07
